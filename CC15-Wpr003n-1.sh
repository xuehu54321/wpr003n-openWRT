...
<link crossorigin="anonymous" media="all" rel="stylesheet" href="https://github.githubassets.com/assets/react-code-view.234ae39ff1fa1232236c.module.css" />
  ...
  <title>Sw-Actions-OpenWrt/CC15-Wpr003n-1.sh at master · sw586/Sw-Actions-OpenWrt</title>
  ...
  <meta name="request-id" content="C823:3C35E9:8F3DF2:9F455F:66C2D50D" data-turbo-transient="true" /><meta name="html-safe-nonce" content="d9716ef25e02089e63007e6c9fc18cad0b68dc2787580d60bb0dcfb9e9d724b5" data-turbo-transient="true" /><meta name="visitor-payload" content="" data-turbo-transient="true" /><meta name="visitor-hmac" content="f093eb3d1ec1368bb312ebfda3c7e7490d6971221e21753e4fdff3124df9efcd" data-turbo-transient="true" />
...
<meta name="octolytics-url" content="https://collector.github.com/github/collect" /><meta name="octolytics-actor-id" content="77148401" /><meta name="octolytics-actor-login" content="zk26" /><meta name="octolytics-actor-hash" content="f42306d4a50a22ef15a2bd53eaf3af50940c0a36305e26994aece9dc312cccc8" />
  ...
  <link rel="sudo-modal" href="/sessions/sudo_modal">
    ...
    <meta name="apple-itunes-app" content="app-id=1477376905, app-argument=https://github.com/sw586/Sw-Actions-OpenWrt/blob/master/CC15-Wpr003n-1.sh" />

      <meta name="twitter:image:src" content="https://opengraph.githubassets.com/bd006763c9954bee723d4465beea77e02e2ff21ecf655e666e8abc7860efd27b/sw586/Sw-Actions-OpenWrt" /><meta name="twitter:site" content="@github" /><meta name="twitter:card" content="summary_large_image" /><meta name="twitter:title" content="Sw-Actions-OpenWrt/CC15-Wpr003n-1.sh at master · sw586/Sw-Actions-OpenWrt" /><meta name="twitter:description" content="Phicomm K2P/Pisen_WPR003N -OpenWrt云编译. Contribute to sw586/Sw-Actions-OpenWrt development by creating an account on GitHub." />
  <meta property="og:image" content="https://opengraph.githubassets.com/bd006763c9954bee723d4465beea77e02e2ff21ecf655e666e8abc7860efd27b/sw586/Sw-Actions-OpenWrt" /><meta property="og:image:alt" content="Phicomm K2P/Pisen_WPR003N -OpenWrt云编译. Contribute to sw586/Sw-Actions-OpenWrt development by creating an account on GitHub." /><meta property="og:image:width" content="1200" /><meta property="og:image:height" content="600" /><meta property="og:site_name" content="GitHub" /><meta property="og:type" content="object" /><meta property="og:title" content="Sw-Actions-OpenWrt/CC15-Wpr003n-1.sh at master · sw586/Sw-Actions-OpenWrt" /><meta property="og:url" content="https://github.com/sw586/Sw-Actions-OpenWrt/blob/master/CC15-Wpr003n-1.sh" /><meta property="og:description" content="Phicomm K2P/Pisen_WPR003N -OpenWrt云编译. Contribute to sw586/Sw-Actions-OpenWrt development by creating an account on GitHub." />
  


      <link rel="shared-web-socket" href="wss://alive.github.com/_sockets/u/77148401/ws?session=eyJ2IjoiVjMiLCJ1Ijo3NzE0ODQwMSwicyI6MTQzMTAyMzc0NiwiYyI6MjEyOTE5NzI2MCwidCI6MTcyNDA0NDU1N30=--b335e8f1b8dc45e9b15160274b6fcf81c97571d4d416ba9a8333d08a886e3835" data-refresh-url="/_alive" data-session-id="e09902aea7fa9f015709934f785e95c8fb40641fbf9a793c139c6edc70c3d175">
...
>
  ...
  <include-fragment data-target="deferred-side-panel.fragment">
      <button aria-label="Open global navigation menu" data-action="click:deferred-side-panel#loadPanel click:deferred-side-panel#panelOpened" data-show-dialog-id="dialog-a351095f-6201-47d9-b26e-fa3e3f697d66" id="dialog-show-dialog-a351095f-6201-47d9-b26e-fa3e3f697d66" type="button" data-view-component="true" class="Button Button--iconOnly Button--secondary Button--medium AppHeader-button color-bg-transparent p-0 color-fg-muted">  <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-three-bars Button-visual">
    <path d="M1 2.75A.75.75 0 0 1 1.75 2h12.5a.75.75 0 0 1 0 1.5H1.75A.75.75 0 0 1 1 2.75Zm0 5A.75.75 0 0 1 1.75 7h12.5a.75.75 0 0 1 0 1.5H1.75A.75.75 0 0 1 1 7.75ZM1.75 12h12.5a.75.75 0 0 1 0 1.5H1.75a.75.75 0 0 1 0-1.5Z"></path>
</svg>
</button>

<dialog-helper>
  <dialog data-target="deferred-side-panel.panel" id="dialog-a351095f-6201-47d9-b26e-fa3e3f697d66" aria-modal="true" aria-labelledby="dialog-a351095f-6201-47d9-b26e-fa3e3f697d66-title" aria-describedby="dialog-a351095f-6201-47d9-b26e-fa3e3f697d66-description" data-view-component="true" class="Overlay Overlay-whenNarrow Overlay--size-small-portrait Overlay--motion-scaleFade Overlay--placement-left SidePanel">
    <div styles="flex-direction: row;" data-view-component="true" class="Overlay-header">
  <div class="Overlay-headerContentWrap">
    <div class="Overlay-titleWrap">
      <h1 class="Overlay-title sr-only" id="dialog-a351095f-6201-47d9-b26e-fa3e3f697d66-title">
        Global navigation
      </h1>
    ...
    <div class="Overlay-actionWrap">
      <button data-close-dialog-id="dialog-a351095f-6201-47d9-b26e-fa3e3f697d66" aria-label="Close" type="button" data-view-component="true" class="close-button Overlay-closeButton"><svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-x">
    <path d="M3.72 3.72a.75.75 0 0 1 1.06 0L8 6.94l3.22-3.22a.749.749 0 0 1 1.275.326.749.749 0 0 1-.215.734L9.06 8l3.22 3.22a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215L8 9.06l-3.22 3.22a.751.751 0 0 1-1.042-.018.751.751 0 0 1-.018-1.042L6.94 8 3.72 4.78a.75.75 0 0 1 0-1.06Z"></path>
      ...
      <scrollable-region data-labelled-by="dialog-a351095f-6201-47d9-b26e-fa3e3f697d66-title">
...
<li data-item-id="" data-targets="nav-list.items" data-view-component="true" class="ActionListItem">
    ...
    <a data-hotkey="g d" data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;HOME&quot;,&quot;label&quot;:null}" id="item-c649f6d3-539c-46f4-aa82-3b38d2c95015" href="/dashboard" data-view-component="true" class="ActionListContent ActionListContent--visual16">
...
<li data-item-id="" data-targets="nav-list.items" data-view-component="true" class="ActionListItem">
    ...
    <a data-hotkey="g i" data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;ISSUES&quot;,&quot;label&quot;:null}" id="item-1dd11f65-8768-4916-b812-0b26c64ec90b" href="/issues" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
...
<li data-item-id="" data-targets="nav-list.items" data-view-component="true" class="ActionListItem">
    ...
    <a data-hotkey="g p" data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;PULL_REQUESTS&quot;,&quot;label&quot;:null}" id="item-1519d642-e0ad-4e72-9af6-b8453b9a3b51" href="/pulls" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
...
<li data-item-id="" data-targets="nav-list.items" data-item-id="projects" data-view-component="true" class="ActionListItem">
    ...
    <a data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;PROJECTS&quot;,&quot;label&quot;:null}" id="item-93b989d8-583a-476f-a148-bd277d92e3a8" href="/projects" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
...
<li data-item-id="" data-targets="nav-list.items" data-view-component="true" class="ActionListItem">
    ...
    <a data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;DISCUSSIONS&quot;,&quot;label&quot;:null}" id="item-dc505d20-08a3-4133-b05e-73363a318629" href="/discussions" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
...
<li data-item-id="" data-targets="nav-list.items" data-view-component="true" class="ActionListItem">
    ...
    <a data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;CODESPACES&quot;,&quot;label&quot;:null}" id="item-fd5d0480-bfc0-40d3-9f07-e25f7010a183" href="https://github.com/codespaces" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
...
<li data-item-id="" data-targets="nav-list.items" data-view-component="true" class="ActionListItem">
    ...
    <a data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;EXPLORE&quot;,&quot;label&quot;:null}" id="item-822c6efc-0ead-4312-949f-fc54371cbe18" href="/explore" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
...
<li data-item-id="" data-targets="nav-list.items" data-view-component="true" class="ActionListItem">
    ...
    <a data-analytics-event="{&quot;category&quot;:&quot;Global navigation&quot;,&quot;action&quot;:&quot;MARKETPLACE&quot;,&quot;label&quot;:null}" id="item-856ec2f3-3c4e-453b-b331-92ab3527f4a1" href="/marketplace" data-view-component="true" class="ActionListContent ActionListContent--visual16">
        <span class="ActionListItem-visual ActionListItem-visual--leading">
    ...
    <path d="M10.68 11.74a6 6 0 0 1-7.922-8.982 6 6 0 0 1 8.982 7.922l3.04 3.04a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215ZM11.5 7a4.499 4.499 0 1 0-8.997 0A4.499 4.499 0 0 0 11.5 7Z"></path>
        ...
        <div data-target="query-builder.styledInputContainer" class="QueryBuilder-StyledInputContainer">
          ...
          <div class="QueryBuilder-InputWrapper">
            ...
            <input id="query-builder-test" name="query-builder-test" value="" autocomplete="off" type="text" role="combobox" spellcheck="false" aria-expanded="false" aria-describedby="validation-b83dbfaa-a68a-4536-a09c-8a988249f00e" data-target="query-builder.input" data-action="
...
<template id="device-desktop-icon">
  <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-device-desktop">
    <path d="M14.25 1c.966 0 1.75.784 1.75 1.75v7.5A1.75 1.75 0 0 1 14.25 12h-3.727c.099 1.041.52 1.872 1.292 2.757A.752.752 0 0 1 11.25 16h-6.5a.75.75 0 0 1-.565-1.243c.772-.885 1.192-1.716 1.292-2.757H1.75A1.75 1.75 0 0 1 0 10.25v-7.5C0 1.784.784 1 1.75 1ZM1.75 2.5a.25.25 0 0 0-.25.25v7.5c0 .138.112.25.25.25h12.5a.25.25 0 0 0 .25-.25v-7.5a.25.25 0 0 0-.25-.25ZM9.018 12H6.982a5.72 5.72 0 0 1-.765 2.5h3.566a5.72 5.72 0 0 1-.765-2.5Z"></path>
      ...
      <div class="FormControl-inlineValidation" id="validation
type="button" data-view-component="true" class="Button Button--iconOnly Button--invisible Button--medium flash-close js-flash-close">  <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="octicon octicon-x Button-visual">
    <path d="M3.72 3.72a.75.75 0 0 1 1.06 0L8 6.94l3.22-3.22a.749.749 0 0 1 1.275.326.749.749 0 0 1-.215.734L9.06 8l3.22 3.22a.749.749 0 0 1-.326 1.275.749.749 0 0 1-.734-.215L8 9.06l-3.22 3.22a.751.751 0 0 1-1.042-.018.751.751 0 0 1-.018-1.042L6.94 8 3.72 4.78a.75.75 0 0 1 0-1.06Z"></path>
</svg>
</button><tool-tip id="tooltip-66d62530-f6b2-4309-9ed8-068e203d2873" for="icon-button-19379b1b-14e3-4d99-9e74-f10245ac0fb5" popover="manual" data-direction="s" data-type="label" data-view-component="true" class="sr-only position-absolute">Dismiss alert</tool-tip>
...
<div class="flash flash-full   {{ className }}">
  <div >
    ...
    <notification-shelf-watcher data-base-url="https://github.com/notifications/beta/shelf" data-channel="eyJjIjoibm90aWZpY2F0aW9uLWNoYW5nZWQ6NzcxNDg0MDEiLCJ0IjoxNzI0MDQ0NTU3fQ==--0d00e46e8d2daed4d71f5431dbaf2da2a71a25ab46398dd758e81678f85238e6" data-view-component="true" class="js-socket-channel"></notification-shelf-watcher>
...
<react-app
  ...
  initial-path="/sw586/Sw-Actions-OpenWrt/blob/master/CC15-Wpr003n-1.sh"
...
>
  ...
  <script type="application/json" data-target="react-app.embeddedData">{"payload":{"allShortcutsEnabled":true,"fileTree":{"":{"items":[{"name":".github","path":".github","contentType":"directory"},{"name":"CC15-DSbox-DSR1.config","path":"CC15-DSbox-DSR1.config","contentType":"file"},{"name":"CC15-Wpr003n-1.sh","path":"CC15-Wpr003n-1.sh","contentType":"file"},{"name":"CC15-Wpr003n-2.sh","path":"CC15-Wpr003n-2.sh","contentType":"file"},{"name":"CC15-Wpr003n.config","path":"CC15-Wpr003n.config","contentType":"file"},{"name":"LEDE-DSbox-DSR1.config","path":"LEDE-DSbox-DSR1.config","contentType":"file"},{"name":"LEDE-K2p.config","path":"LEDE-K2p.config","contentType":"file"},{"name":"LEDE-Wpr003n-1.sh","path":"LEDE-Wpr003n-1.sh","contentType":"file"},{"name":"LEDE-Wpr003n-2.sh","path":"LEDE-Wpr003n-2.sh","contentType":"file"},{"name":"LEDE-Wpr003n.config","path":"LEDE-Wpr003n.config","contentType":"file"},{"name":"LICENSE","path":"LICENSE","contentType":"file"},{"name":"OP19-DSbox-DSR1-1.sh","path":"OP19-DSbox-DSR1-1.sh","contentType":"file"},{"name":"OP19-DSbox-DSR1-2.sh","path":"OP19-DSbox-DSR1-2.sh","contentType":"file"},{"name":"Op19-DSbox-DSR1.config","path":"Op19-DSbox-DSR1.config","contentType":"file"},{"name":"README.md","path":"README.md","contentType":"file"},{"name":"diy-part1.sh","path":"diy-part1.sh","contentType":"file"},{"name":"diy-part2.sh","path":"diy-part2.sh","contentType":"file"}],"totalCount":17}},"fileTreeProcessingTime":2.532299,"foldersToFetch":[],"repo":{"id":428190378,"defaultBranch":"master","name":"Sw-Actions-OpenWrt","ownerLogin":"sw586","currentUserCanPush":false,"isFork":false,"isEmpty":false,"createdAt":"2021-11-15T16:59:44.000+08:00","ownerAvatar":"https://avatars.githubusercontent.com/u/24788222?v=4","public":true,"private":false,"isOrgOwned":false},"codeLineWrapEnabled":false,"symbolsExpanded":true,"treeExpanded":true,"refInfo":{"name":"master","listCacheKey":"v0:1636966784.7264938","canEdit":true,"refType":"branch","currentOid":"a1feec79a8e349c1acda3d1ccf8353a9968f95e4"},"path":"CC15-Wpr003n-1.sh","currentUser":{"id":77148401,"login":"zk26","userEmail":"284666014@qq.com"},"blob":{"rawLines":["# !/bin/bash","#","# Copyright (c) 2019-2020 P3TERX \u003chttps://p3terx.com\u003e","#","# This is free software, licensed under the MIT License.","# See /LICENSE for more information.","#","# https://github.com/P3TERX/Actions-OpenWrt","# File name: diy-part1.sh","# Description: OpenWrt DIY script part 1 (Before Update feeds)","#","","# Uncomment a feed source","#sed -i 's/^#\\(.*helloworld\\)/\\1/' feeds.conf.default","","# Add a feed source","#echo 'src-git helloworld https://github.com/fw876/helloworld' \u003e\u003efeeds.conf.default","#echo 'src-git passwall https://github.com/xiaorouji/openwrt-passwall' \u003e\u003efeeds.conf.default","","","# sudo timedatectl set-timezone \"Asia/Shanghai\"","","# Install the tools you need to use","# sudo apt update","# sudo apt-get install build-essential asciidoc binutils bzip2 gawk gettext git subversion libssl-dev libncurses5-dev patch unzip zlib1g-dev libc6-dev libbz2-dev gdisk flex python2","# git clone https://github.com/syb999/openwrt-15.05.git"],"stylingDirectives":null,"colorizedLines":["\u003cspan class=\"pl-c\"\u003e\u003cspan class=\"pl-c\"\u003e#\u003c/span\u003e !/bin/bash\u003c/span\u003e","\u003cspan class=\"pl-c\"\u003e\u003cspan class=\"pl-c\"\u003e#\u003c/span\u003e\u003c/span\u003e","\u003cspan class=\"pl-c\"\u003e\u003cspan class=\"pl-c\"\u003e#\u003c/span\u003e Copyright (c) 2019-2020 P3TERX \u0026lt;https://p3terx.com\u0026gt;\u003c/span\u003e","\u003cspan class=\"pl-c\"\u003e\u003cspan class=\"pl-c\"\u003e#\u003c/span\u003e\u003c/span\u003e","\u003cspan class=\"pl-c\"\u003e\u003cspan class=\"pl-c\"\u003e#\u003c/span\u003e This is free software, licensed under the MIT License.\u003c/span\u003e","\u003cspan class=\"pl-c\"\u003e\u003cspan class=\"pl-c\"\u003e#\u003c/span\u003e See /LICENSE for more information.\u003c/span\u003e","\u003cspan class=\"pl-c\"\u003e\u003cspan class=\"pl-c\"\u003e#\u003c/span\u003e\u003c/span\u003e","\u003cspan class=\"pl-c\"\u003e\u003cspan class=\"pl-c\"\u003e#\u003c/span\u003e https://github.com/P3TERX/Actions-OpenWrt\u003c/span\u003e","\u003cspan class=\"pl-c\"\u003e\u003cspan class=\"pl-c\"\u003e#\u003c/span\u003e File name: diy-part1.sh\u003c/span\u003e","\u003cspan class=\"pl-c\"\u003e\u003cspan class=\"pl-c\"\u003e#\u003c/span\u003e Description: OpenWrt DIY script part 1 (Before Update feeds)\u003c/span\u003e","\u003cspan class=\"pl-c\"\u003e\u003cspan class=\"pl-c\"\u003e#\u003c/span\u003e\u003c/span\u003e","","\u003cspan class=\"pl-c\"\u003e\u003cspan class=\"pl-c\"\u003e#\u003c/span\u003e Uncomment a feed source\u003c/span\u003e","\u003cspan class=\"pl-c\"\u003e\u003cspan class=\"pl-c\"\u003e#\u003c/span\u003esed -i \u0026#39;s/^#\\(.*helloworld\\)/\\1/\u0026#39; feeds.conf.default\u003c/span\u003e","","\u003cspan class=\"pl-c\"\u003e\u003cspan class=\"pl-c\"\u003e#\u003c/span\u003e Add a feed source\u003c/span\u003e","\u003cspan class=\"pl-c\"\u003e\u003cspan class=\"pl-c\"\u003e#\u003c/span\u003eecho \u0026#39;src-git helloworld https://github.com/fw876/helloworld\u0026#39; \u0026gt;\u0026gt;feeds.conf.default\u003c/span\u003e","\u003cspan class=\"pl-c\"\u003e\u003cspan class=\"pl-c\"\u003e#\u003c/span\u003eecho \u0026#39;src-git passwall https://github.com/xiaorouji/openwrt-passwall\u0026#39; \u0026gt;\u0026gt;feeds.conf.default\u003c/span\u003e","","","\u003cspan class=\"pl-c\"\u003e\u003cspan class=\"pl-c\"\u003e#\u003c/span\u003e sudo timedatectl set-timezone \u0026quot;Asia/Shanghai\u0026quot;\u003c/span\u003e","","\u003cspan class=\"pl-c\"\u003e\u003cspan class=\"pl-c\"\u003e#\u003c/span\u003e Install the tools you need to use\u003c/span\u003e","\u003cspan class=\"pl-c\"\u003e\u003cspan class=\"pl-c\"\u003e#\u003c/span\u003e sudo apt update\u003c/span\u003e","\u003cspan class=\"pl-c\"\u003e\u003cspan class=\"pl-c\"\u003e#\u003c/span\u003e sudo apt-get install build-essential asciidoc binutils bzip2 gawk gettext git subversion libssl-dev libncurses5-dev patch unzip zlib1g-dev libc6-dev libbz2-dev gdisk flex python2\u003c/span\u003e","\u003cspan class=\"pl-c\"\u003e\u003cspan class=\"pl-c\"\u003e#\u003c/span\u003e git clone https://github.com/syb999/openwrt-15.05.git\u003c/span\u003e"],"csv":null,"csvError":null,"dependabotInfo":{"showConfigurationBanner":false,"configFilePath":null,"networkDependabotPath":"/sw586/Sw-Actions-OpenWrt/network/updates","dismissConfigurationNoticePath":"/settings/dismiss-notice/dependabot_configuration_notice","configurationNoticeDismissed":false},"displayName":"CC15-Wpr003n-1.sh","displayUrl":"https://github.com/sw586/Sw-Actions-OpenWrt/blob/master/CC15-Wpr003n-1.sh?raw=true","headerInfo":{"blobSize":"922 Bytes","deleteTooltip":"Fork this repository and delete the file","editTooltip":"Fork this repository and edit the file","ghDesktopPath":"https://desktop.github.com","isGitLfs":false,"onBranch":true,"shortPath":"90f6647","siteNavLoginPath":"/login?return_to=https%3A%2F%2Fgithub.com%2Fsw586%2FSw-Actions-OpenWrt%2Fblob%2Fmaster%2FCC15-Wpr003n-1.sh","isCSV":false,"isRichtext":false,"toc":null,"lineInfo":{"truncatedLoc":"26","truncatedSloc":"21"},"mode":"file"},"image":false,"isCodeownersFile":null,"isPlain":false,"isValidLegacyIssueTemplate":false,"issueTemplate":null,"discussionTemplate":null,"language":"Shell","languageID":346,"large":false,"planSupportInfo":{"repoIsFork":null,"repoOwnedByCurrentUser":null,"requestFullPath":"/sw586/Sw-Actions-OpenWrt/blob/master/CC15-Wpr003n-1.sh","showFreeOrgGatedFeatureMessage":null,"showPlanSupportBanner":null,"upgradeDataAttributes":null,"upgradePath":null},"publishBannersInfo":{"dismissActionNoticePath":"/settings/dismiss-notice/publish_action_from_dockerfile","releasePath":"/sw586/Sw-Actions-OpenWrt/releases/new?marketplace=true","showPublishActionBanner":false},"rawBlobUrl":"https://github.com/sw586/Sw-Actions-OpenWrt/raw/master/CC15-Wpr003n-1.sh","renderImageOrRaw":false,"richText":null,"renderedFileInfo":null,"shortPath":null,"symbolsEnabled":true,"tabSize":8,"topBannersInfo":{"overridingGlobalFundingFile":false,"globalPreferredFundingPath":null,"showInvalidCitationWarning":false,"citationHelpUrl":"https://docs.github.com/github/creating-cloning-and-archiving-repositories/creating-a-repository-on-github/about-citation-files","actionsOnboardingTip":null},"truncated":false,"viewable":true,"workflowRedirectUrl":null,"symbols":{"timed_out":false,"not_analyzed":false,"symbols":[]}},"copilotInfo":{"documentationUrl":"https://docs.github.com/copilot/overview-of-github-copilot/about-github-copilot-for-individuals","notices":{"codeViewPopover":{"dismissed":false,"dismissPath":"/settings/dismiss-notice/code_view_copilot_popover"}},"userAccess":{"hasSubscriptionEnded":false,"orgHasCFBAccess":false,"userHasCFIAccess":false,"userHasOrgs":false,"userIsOrgAdmin":false,"userIsOrgMember":false,"business":null,"featureRequestInfo":null}},"copilotAccessAllowed":false,"csrf_tokens":{"/sw586/Sw-Actions-OpenWrt/branches":{"post":"170tQvlvqj9ra3QC0CzytwvTi2wzJq-uMBHterwF2kWwvj46tn1CUSDusLD-AfJhId0vKEpn638nMQIfWhJm5A"},"/repos/preferences":{"post":"38tQWLS8d_n9mRijp1Gm3jURmGew6D_wGqvvdha0uje9pmFSvq_3A-8lUful8R6vX7JhSsPAhjrGrEfY2zdOTw"}}},"title":"Sw-Actions-OpenWrt/CC15-Wpr003n-1.sh at master · sw586/Sw-Actions-OpenWrt","appPayload":{"helpUrl":"https://docs.github.com","findFileWorkerPath":"/assets-cdn/worker/find-file-worker-1583894afd38.js","findInFileWorkerPath":"/assets-cdn/worker/find-in-file-worker-3a63a487027b.js","githubDevUrl":"https://github.dev/","enabled_features":{"code_nav_ui_events":false,"overview_shared_code_dropdown_button":false,"react_blob_overlay":true,"copilot_conversational_ux_embedding_update":false,"copilot_smell_icebreaker_ux":true,"copilot_workspace":false}}}</script>
...
<div id="LC9" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div "><span class="pl-c"><span class="pl-c">#</span> File name: diy-part1.sh</span></div>
<div id="LC10" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div "><span class="pl-c"><span class="pl-c">#</span> Description: OpenWrt DIY script part 1 (Before Update feeds)</span></div>
...
<div id="LC13" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div "><span class="pl-c"><span class="pl-c">#</span> Uncomment a feed source</span></div>
<div id="LC14" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div "><span class="pl-c"><span class="pl-c">#</span>sed -i &#39;s/^#\(.*helloworld\)/\1/&#39; feeds.conf.default</span></div>
<div id="LC15" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div ">
</div>
<div id="LC16" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div "><span class="pl-c"><span class="pl-c">#</span> Add a feed source</span></div>
<div id="LC17" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div "><span class="pl-c"><span class="pl-c">#</span>echo &#39;src-git helloworld https://github.com/fw876/helloworld&#39; &gt;&gt;feeds.conf.default</span></div>
<div id="LC18" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div "><span class="pl-c"><span class="pl-c">#</span>echo &#39;src-git passwall https://github.com/xiaorouji/openwrt-passwall&#39; &gt;&gt;feeds.conf.default</span></div>
...
<div id="LC21" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div "><span class="pl-c"><span class="pl-c">#</span> sudo timedatectl set-timezone &quot;Asia/Shanghai&quot;</span></div>
<div id="LC22" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div ">
</div>
<div id="LC23" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div "><span class="pl-c"><span class="pl-c">#</span> Install the tools you need to use</span></div>
<div id="LC24" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div "><span class="pl-c"><span class="pl-c">#</span> sudo apt update</span></div>
<div id="LC25" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div "><span class="pl-c"><span class="pl-c">#</span> sudo apt-get install build-essential asciidoc binutils bzip2 gawk gettext git subversion libssl-dev libncurses5-dev patch unzip zlib1g-dev libc6-dev libbz2-dev gdisk flex python2</span></div>
<div id="LC26" class="react-code-text react-code-line-contents-no-virtualization react-file-line html-div "><span class="pl-c"><span class="pl-c">#</span> git clone https://github.com/syb999/openwrt-15.05.git</span></div></div></div></div></div><div id="copilot-button-container"></div></div><div id="highlighted-line-menu-container"></div></div></div><button hidden="" data-testid="hotkey-button" data-hotkey-scope="read-only-cursor-text-area"></button><button hidden=""></button></section></div></div></div> <!-- --> <!-- --> </div></div></div><div class="Box-sc-g0xbh4-0"></div></div></div></div></div><div id="find-result-marks-container" class="Box-sc-g0xbh4-0 aZrVR"></div><button hidden="" data-testid="" data-hotkey-scope="read-only-cursor-text-area"></button><button hidden=""></button></div> <!-- --> <!-- --> <script type="application/json" id="__PRIMER_DATA_:R0:__">{"resolvedServerColorMode":"day"}</script></div>
</react-app>
</turbo-frame>
